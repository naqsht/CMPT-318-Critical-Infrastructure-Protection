...
test_data_spring_weekday<-read.csv("test5_spring_weekday.txt", header = TRUE, sep = ",", dec = ".")
test_data_spring_weekend<-read.csv("test5_spring_weekend.txt", header = TRUE, sep = ",", dec = ".")
test_data_summer_weekday<-read.csv("test5_summer_weekday.txt", header = TRUE, sep = ",", dec = ".")
test_data_summer_weekend<-read.csv("test5_summer_weekend.txt", header = TRUE, sep = ",", dec = ".")
test_data_autumn_weekday<-read.csv("test5_autumn_weekday.txt", header = TRUE, sep = ",", dec = ".")
test_data_autumn_weekend<-read.csv("test5_autumn_weekend.txt", header = TRUE, sep = ",", dec = ".")
test_data_winter_weekday<-read.csv("test5_winter_weekday.txt", header = TRUE, sep = ",", dec = ".")
test_data_winter_weekend<-read.csv("test5_winter_weekend.txt", header = TRUE, sep = ",", dec = ".")
