...
test_data_spring_weekday<-read.csv("test3_spring_weekday.txt", header = TRUE, sep = ",", dec = ".")
test_data_spring_weekend<-read.csv("test3_spring_weekend.txt", header = TRUE, sep = ",", dec = ".")
test_data_summer_weekday<-read.csv("test3_summer_weekday.txt", header = TRUE, sep = ",", dec = ".")
test_data_summer_weekend<-read.csv("test3_summer_weekend.txt", header = TRUE, sep = ",", dec = ".")
test_data_autumn_weekday<-read.csv("test3_autumn_weekday.txt", header = TRUE, sep = ",", dec = ".")
test_data_autumn_weekend<-read.csv("test3_autumn_weekend.txt", header = TRUE, sep = ",", dec = ".")
test_data_winter_weekday<-read.csv("test3_winter_weekday.txt", header = TRUE, sep = ",", dec = ".")
test_data_winter_weekend<-read.csv("test3_winter_weekend.txt", header = TRUE, sep = ",", dec = ".")
...
########################################################################################################################################################################
hmm_winter_weekday <- depmix(hmm_features, data=train_data_winter_weekday, nstates=6,ntimes=unlist(countLines(train_data_winter_weekday), use.names=FALSE),
                             family=family_list)
fhmm_winter_weekday <- fit(hmm_winter_weekday)
print(fhmm_winter_weekday)
hmm_winter_weekday_test <- depmix(hmm_features, data=test_data_winter_weekday, nstates=6, ntimes= unlist(countLines(test_data_winter_weekday), use.names=FALSE),
                                  family=family_list)
