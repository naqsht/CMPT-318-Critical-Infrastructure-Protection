...
###################################################################################
hmm_summer_weekday <- depmix(hmm_features, data=train_data_summer_weekday, nstates=4,ntimes=unlist(countLines(train_data_summer_weekday), use.names=FALSE),
                             family=list(gaussian(),gaussian()))
fhmm_summer_weekday <- fit(hmm_summer_weekday)
print(fhmm_summer_weekday)
hmm_summer_weekday_test <- depmix(hmm_features, data=test_data_summer_weekday, nstates=4, ntimes= unlist(countLines(test_data_summer_weekday), use.names=FALSE),
                                  family=list(gaussian(),gaussian()))
...
######################################################################################
hmm_wintor_weekday <- depmix(hmm_features, data=train_data_wintor_weekday, nstates=4,ntimes=unlist(countLines(train_data_wintor_weekday), use.names=FALSE),
                             family=list(gaussian(),gaussian()))
fhmm_wintor_weekday <- fit(hmm_wintor_weekday)
print(fhmm_wintor_weekday)
hmm_wintor_weekday_test <- depmix(hmm_features, data=test_data_wintor_weekday, nstates=4, ntimes= unlist(countLines(test_data_wintor_weekday), use.names=FALSE),
                                  family=list(gaussian(),gaussian()))
hmm_wintor_weekday_test <- setpars(hmm_wintor_weekday_test,getpars(fhmm_wintor_weekday))
logLik(hmm_wintor_weekday_test)
######################################################################################
...
######################################################################################
hmm_autumn_weekend <- depmix(hmm_features, data=train_data_autumn_weekend, nstates=4,ntimes=unlist(countLines(train_data_autumn_weekend), use.names=FALSE),
                             family=list(gaussian(),gaussian()))
fhmm_autumn_weekend <- fit(hmm_autumn_weekend)
print(fhmm_autumn_weekend)
hmm_autumn_weekend_test <- depmix(hmm_features, data=test_data_autumn_weekend, nstates=4, ntimes= unlist(countLines(test_data_autumn_weekend), use.names=FALSE),
                                  family=list(gaussian(),gaussian()))
hmm_autumn_weekend_test <- setpars(hmm_autumn_weekend_test,getpars(fhmm_autumn_weekend))
logLik(hmm_autumn_weekend_test)
######################################################################################
hmm_wintor_weekend <- depmix(hmm_features, data=train_data_wintor_weekend, nstates=4,ntimes=unlist(countLines(train_data_wintor_weekend), use.names=FALSE),
                             family=list(gaussian(),gaussian()))
fhmm_wintor_weekend <- fit(hmm_wintor_weekend)
print(fhmm_wintor_weekend)
hmm_wintor_weekend_test <- depmix(hmm_features, data=test_data_wintor_weekend, nstates=4, ntimes= unlist(countLines(test_data_wintor_weekend), use.names=FALSE),
                                  family=list(gaussian(),gaussian()))
hmm_wintor_weekend_test <- setpars(hmm_wintor_weekend_test,getpars(fhmm_wintor_weekend))
logLik(hmm_wintor_weekend_test)
######################################################################################