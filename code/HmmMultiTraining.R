...
hmm_autumn_weekday_test <- depmix(hmm_features, data=test_data_autumn_weekday, nstates=10, ntimes= unlist(countLines(test_data_autumn_weekday), use.names=FALSE),
                                  family=family_list)
...
hmm_spring_weekend_test <- depmix(hmm_features, data=test_data_spring_weekend, nstates=16, ntimes= unlist(countLines(test_data_spring_weekend), use.names=FALSE),
                                  family=family_list)
