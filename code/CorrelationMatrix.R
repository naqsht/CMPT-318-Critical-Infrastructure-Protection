...
#   
# }
#write.table(data, "data_without_NA.txt", append = FALSE, sep = ",", dec = ".",
#            row.names = FALSE, col.names = TRUE)


data <- read.csv("data_without_NA.txt", header = TRUE, sep = ",", dec = ".")
count <- nrow(data)
...
corrplot(correlation_mat, method = 'color', order="hclust", addCoef.col = 'black', tl.col="black", tl.srt=20, type="upper",mar=c(0.01,0.01,0.01,0.01))
