...
hmm_spring_weekday_test <- depmix(hmm_features, data=train_data_test_spring_weekday, nstates=7, ntimes= unlist(countLines(train_data_test_spring_weekday), use.names=FALSE),
                                  family=family_list)
...
hmm_summer_weekday_test <- depmix(hmm_features, data=train_data_test_summer_weekday, nstates=6, ntimes= unlist(countLines(train_data_test_summer_weekday), use.names=FALSE),
                                  family=family_list)
...
hmm_autumn_weekday_test <- depmix(hmm_features, data=train_data_test_autumn_weekday, nstates=4, ntimes= unlist(countLines(train_data_test_autumn_weekday), use.names=FALSE),
                                  family=family_list)
...
hmm_spring_weekend_test <- depmix(hmm_features, data=train_data_test_spring_weekend, nstates=5, ntimes= unlist(countLines(train_data_test_spring_weekend), use.names=FALSE),
                                  family=family_list)
...
hmm_summer_weekend_test <- depmix(hmm_features, data=train_data_test_summer_weekend, nstates=6, ntimes= unlist(countLines(train_data_test_summer_weekend), use.names=FALSE),
                                  family=family_list)
...
hmm_autumn_weekend_test <- depmix(hmm_features, data=train_data_test_autumn_weekend, nstates=7, ntimes= unlist(countLines(train_data_test_autumn_weekend), use.names=FALSE),
                                  family=family_list)
...
hmm_winter_weekend_test <- depmix(hmm_features, data=train_data_test_winter_weekend, nstates=5, ntimes= unlist(countLines(train_data_test_winter_weekend), use.names=FALSE),
                                  family=family_list)
