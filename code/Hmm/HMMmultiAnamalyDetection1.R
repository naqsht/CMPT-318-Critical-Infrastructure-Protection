...
test_data_spring_weekday<-read.csv("test1_spring_weekday.txt", header = TRUE, sep = ",", dec = ".")
test_data_spring_weekend<-read.csv("test1_spring_weekend.txt", header = TRUE, sep = ",", dec = ".")
test_data_summer_weekday<-read.csv("test1_summer_weekday.txt", header = TRUE, sep = ",", dec = ".")
test_data_summer_weekend<-read.csv("test1_summer_weekend.txt", header = TRUE, sep = ",", dec = ".")
test_data_autumn_weekday<-read.csv("test1_autumn_weekday.txt", header = TRUE, sep = ",", dec = ".")
test_data_autumn_weekend<-read.csv("test1_autumn_weekend.txt", header = TRUE, sep = ",", dec = ".")
test_data_winter_weekday<-read.csv("test1_winter_weekday.txt", header = TRUE, sep = ",", dec = ".")
test_data_winter_weekend<-read.csv("test1_winter_weekend.txt", header = TRUE, sep = ",", dec = ".")
...
hmm_spring_weekday_test <- depmix(hmm_features, data=test_data_spring_weekday, nstates=16, ntimes= unlist(countLines(test_data_spring_weekday), use.names=FALSE),
                                  family=family_list)
...
hmm_autumn_weekday <- depmix(hmm_features, data=train_data_autumn_weekday, nstates=6,ntimes=unlist(countLines(train_data_autumn_weekday), use.names=FALSE),
                             family=family_list)
fhmm_autumn_weekday <- fit(hmm_autumn_weekday)
print(fhmm_autumn_weekday)
hmm_autumn_weekday_test <- depmix(hmm_features, data=test_data_autumn_weekday, nstates=6, ntimes= unlist(countLines(test_data_autumn_weekday), use.names=FALSE),
                                  family=family_list)
hmm_autumn_weekday_test <- setpars(hmm_autumn_weekday_test,getpars(fhmm_autumn_weekday))
logLik(hmm_autumn_weekday_test)
########################################################################################################################################################################
hmm_winter_weekday <- depmix(hmm_features, data=train_data_winter_weekday, nstates=5,ntimes=unlist(countLines(train_data_winter_weekday), use.names=FALSE),
                             family=family_list)
fhmm_winter_weekday <- fit(hmm_winter_weekday)
print(fhmm_winter_weekday)
hmm_winter_weekday_test <- depmix(hmm_features, data=test_data_winter_weekday, nstates=5, ntimes= unlist(countLines(test_data_winter_weekday), use.names=FALSE),
                                  family=family_list)
hmm_winter_weekday_test <- setpars(hmm_winter_weekday_test,getpars(fhmm_winter_weekday))
logLik(hmm_winter_weekday_test)
########################################################################################################################################################################

hmm_spring_weekend <- depmix(hmm_features, data=train_data_spring_weekend, nstates=4,ntimes=unlist(countLines(train_data_spring_weekend), use.names=FALSE),
                             family=family_list)
fhmm_spring_weekend <- fit(hmm_spring_weekend)
print(fhmm_spring_weekend)
hmm_spring_weekend_test <- depmix(hmm_features, data=test_data_spring_weekend, nstates=4, ntimes= unlist(countLines(test_data_spring_weekend), use.names=FALSE),
                                  family=family_list)
...
hmm_summer_weekend <- depmix(hmm_features, data=train_data_summer_weekend, nstates=4,ntimes=unlist(countLines(train_data_summer_weekend), use.names=FALSE),
                             family=family_list)
fhmm_summer_weekend <- fit(hmm_summer_weekend)
print(fhmm_summer_weekend)
hmm_summer_weekend_test <- depmix(hmm_features, data=test_data_summer_weekend, nstates=4, ntimes= unlist(countLines(test_data_summer_weekend), use.names=FALSE),
                                  family=family_list)
...
hmm_autumn_weekend_test <- depmix(hmm_features, data=test_data_autumn_weekend, nstates=9, ntimes= unlist(countLines(test_data_autumn_weekend), use.names=FALSE),
                                  family=family_list)
hmm_autumn_weekend_test <- setpars(hmm_autumn_weekend_test,getpars(fhmm_autumn_weekend))
logLik(hmm_autumn_weekend_test)
########################################################################################################################################################################

hmm_winter_weekend <- depmix(hmm_features, data=train_data_winter_weekend, nstates=6,ntimes=unlist(countLines(train_data_winter_weekend), use.names=FALSE),
                             family=family_list)
fhmm_winter_weekend <- fit(hmm_winter_weekend)
print(fhmm_winter_weekend)
hmm_winter_weekend_test <- depmix(hmm_features, data=test_data_winter_weekend, nstates=6, ntimes= unlist(countLines(test_data_winter_weekend), use.names=FALSE),
                                  family=family_list)
